use super::model::{CouponInsertRequest, CouponError, CouponUpdateRequest, CouponQueryRequest};
...
#[tracing::instrument( name = "Delete coupon by id", skip(pool) )]
#[delete("/id")]
...
#[tracing::instrument( name = "Delete coupon by code", skip(pool) )]
#[delete("/code")]
